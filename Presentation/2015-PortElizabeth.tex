...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in calling(CGHo) <- TRUE: object 'CGHo' not found}}\begin{alltt}
\hlstd{CGHo}\hlopt{@}\hlkwc{nblevels}\hlkwb{=}\hlnum{2}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in CGHo@nblevels = 2: object 'CGHo' not found}}\begin{alltt}
\hlstd{segSignal}   \hlkwb{<-} \hlkwd{uniseg}\hlstd{(}\hlkwc{.Object}\hlstd{=signalCGH,}\hlkwc{CGHo}\hlstd{=CGHo)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in uniseg(.Object = signalCGH, CGHo = CGHo): error in evaluating the argument '.Object' in selecting a method for function 'uniseg': Error: object 'signalCGH' not found}}\begin{alltt}
\hlstd{segSignalProf} \hlkwb{<-} \hlkwd{getsegprofiles}\hlstd{(segSignal)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in getsegprofiles(segSignal): error in evaluating the argument '.Object' in selecting a method for function 'getsegprofiles': Error: object 'segSignal' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in lines(1:length(segSignalProf), segSignalProf, type = "{}s"{}, col = 2, : object 'segSignalProf' not found}}\end{kframe}
\end{knitrout}
\end{column}
\begin{column}{0.5\textwidth}
